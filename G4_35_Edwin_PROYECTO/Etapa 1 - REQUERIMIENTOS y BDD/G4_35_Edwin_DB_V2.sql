...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2021 a las 16:03:27
...
(1, 'pedro', 'ramon ', 'colo priedras bonitas', 27725588, 301154525, 45954),
(2, 'Nazareth ', 'Hernandez', 'brisas de altamira', 6121655, 6265656, 465456);
...
(1, 2, 4848, 'Hernandez', 'colonia piedras bonita', 2, 'tarjeta\r\n'),
(2, 3, 4521, 'Hernandez', 'brisas altamira', 1, 'tarjeta');

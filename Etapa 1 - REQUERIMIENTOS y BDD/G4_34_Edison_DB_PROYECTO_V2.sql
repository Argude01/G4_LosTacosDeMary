...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2021 a las 16:17:43
...
(1, 'María ', 'Moncada', 'BARRIO ARRIBA COMAYAGUA', 27726625, 301815651, 548752136);
...
(1, 4, 245, 'MONCADA', 'BARRIO ARRIBA COMAYAGUA', 1, 'EFECTIVO'),
(2, 8, 548, 'TORRES', 'Barrio Torondon', 1, 'efectivo');
...
--
ALTER TABLE `tbl_clientes`
  MODIFY `ID_NOMBRE` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

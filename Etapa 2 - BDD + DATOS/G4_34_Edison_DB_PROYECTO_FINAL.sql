...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2021 a las 15:35:56
...
--
-- Base de datos: `db_los_tacos_de_mary`
--
...
(2, 'EDISON', 123, 1, 'BARRIO LA INDEPENDENCIA', 27726625, 301815651, 1256897463),
(3, 'MARTHA', 321, 1, 'BARRIO ARRIBA', 27722154, 301981545, 475862154),
(4, 'MANUEL', 789, 1, 'BARRIO LOS LIRIOS', 27721458, 30165895, 548487231),
(5, 'CARLOS', 519, 2, NULL, 27724586, 1244756221, 653298741),
(6, 'MARCOS', 258, 2, 'BARRIO SAN SEBASTIAN', 27725487, 301457896, 685479124);
...
(3, 3, 14, 'BARRIO LA INDEPENDECNIA', 3, 'EFECTIVO'),
(4, 4, 548, 'BARRIO LOR LIRIOS', 4, 'EFECTIVO'),
(5, 5, 11, 'COLONIA 3 CAMINOS', 1, 'EFECTIVO');
